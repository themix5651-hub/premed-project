  ...
  return (
    <main style={{ background: '#f5f7fa', minHeight: '100vh', fontFamily: 'system-ui, sans-serif' }}>
      ...
      <section style={{
        ...
        <div style={{ position: 'absolute', top: -80, left: '50%', transform: 'translateX(-50%)', width: 520, height: 400, background: 'radial-gradient(ellipse, rgba(30,80,160,0.28) 0%, transparent 68%)', pointerEvents: 'none' }} />
        <div style={{ position: 'absolute', bottom: -40, right: -40, width: 200, height: 200, background: 'radial-gradient(ellipse, rgba(126,184,224,0.07) 0%, transparent 70%)', pointerEvents: 'none' }} />
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'rgba(126,184,224,0.1)', border: '0.5px solid rgba(126,184,224,0.22)', padding: '6px 16px', borderRadius: 9999, marginBottom: 24 }}>
          <div style={{ width: 5, height: 5, background: '#7eb8e0', borderRadius: '50%' }} />
          <span style={{ fontSize: 11, color: '#7eb8e0', letterSpacing: '0.05em' }}>Free · No credit card · Built for MD applicants</span>
        </div>
        <p style={{ fontSize: 13, color: 'rgba(245,247,250,0.4)', marginBottom: 10, letterSpacing: '0.01em' }}>My Premed Path</p>
        <h1 style={{ marginBottom: 18, lineHeight: 1.1, letterSpacing: '-0.03em' }}>
          <span style={{ display: 'block', fontSize: 48, fontWeight: 400, color: '#f5f7fa', fontFamily: 'Georgia, serif' }}>Know exactly where your</span>
        ...
        <div style={{ display: 'flex', gap: 10, justifyContent: 'center', flexWrap: 'wrap' }}>
          ...
          <button onClick={() => document.getElementById('how-it-works')?.scrollIntoView({ behavior: 'smooth' })} style={{ background: 'transparent', color: 'rgba(245,247,250,0.45)', border: '0.5px solid rgba(245,247,250,0.15)', padding: '14px 22px', borderRadius: 9999, fontSize: 14, cursor: 'pointer' }}>
            See how it works
          </button>
        </div>
      ...
      <section style={{ background: '#f5f7fa', padding: '56px 40px' }}>
        <div style={{ maxWidth: 480, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 28 }}>
            {[
              { label: 'Log clinical hours', sub: 'Track hours by category with supervisor name, email, and organization' },
              { label: 'Watch your score grow', sub: 'Every time you log activity, your bars update in real time' },
              { label: 'Know your weak spots', sub: 'See exactly which categories need attention before you apply' },
      ...
      <section id="how-it-works" style={{ background: '#f5f7fa', padding: '56px 40px 48px' }}>
        <p style={{ textAlign: 'center', fontSize: 10, letterSpacing: '0.14em', textTransform: 'uppercase', color: '#8a9eb8', marginBottom: 32 }}>How it works</p>
      ...
      <section style={{ background: '#edf1f7', padding: '0 40px 56px', borderTop: '0.5px solid #dde3ed' }}>
        <p style={{ textAlign: 'center', fontSize: 10, letterSpacing: '0.14em', textTransform: 'uppercase', color: '#8a9eb8', paddingTop: 48, marginBottom: 24 }}>What your results look like</p>
        <div style={{ maxWidth: 460, margin: '0 auto', borderRadius: 18, overflow: 'hidden', border: '0.5px solid #d0d9e8' }}>
          <div style={{ background: '#0f1f3d', padding: '26px 24px 22px' }}>
            <p style={{ fontSize: 10, color: 'rgba(126,184,224,0.5)', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 8 }}>Readiness Score</p>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16 }}>
              ...
              <div style={{ background: 'rgba(126,184,224,0.12)', color: '#7eb8e0', fontSize: 11, padding: '7px 16px', borderRadius: 9999, border: '0.5px solid rgba(126,184,224,0.2)' }}>Competitive</div>
            </div>
